...
Skill names below are bare (`elicit`, `distill`, `propagate`, `tend`, `weed`); in ECA they are invoked as namespaced plugin skills — `/allium:elicit`, `/allium:distill`, and so on.
